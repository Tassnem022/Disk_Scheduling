 ...
 * @author DELL
 */
public class ScanDown extends javax.swing.JFrame {

    /**
     * Creates new form ScanDown
     */
    public ScanDown() {
        initComponents();
    }
...
public  void scanDown(int[] list, int head) {
        int start = 0, end = 199, total = 0;
        ...
        for (int i = list.length-1; i >= 0; i--) {
         ...
         jTextArea1.append(String.valueOf(start+"\n"));
        total += Math.abs(currentHead - start);
        currentHead = start;
        // print last half
        for (int k=j; k<list.length ; k++) {
            jTextArea1.append(String.valueOf(list[k]+"\n"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScanDown.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
